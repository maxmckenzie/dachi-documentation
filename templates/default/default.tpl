...
<head>
    ...
    <style type="text/css">
    pre { background: #222; border-color: #333!important; }
    body { background: #111; }
    .hljs { color: #AAA; }
    .hljs.language-none, .hljs.language-none span { color: #AAA !important; }
    .sub-nav-collapse>.nav>li:nth-child(3) { margin-bottom: 2em; }
    .sub-nav-collapse>.nav>li>ul .aj-nav.folder { font-weight: bold; }


    .sub-nav-collapse>.nav>li:nth-last-child(1) { margin-top: 2em; }
    .sub-nav-collapse>.nav>li:nth-last-child(1) a { font-size: 0.8em!important; }
    </style>
</head>
<body>
    <?php if ($homepage) { ?>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-5 col-sm-offset-1">
                        ...
                        <small style="opacity: 1; color: #bbb;">generated with <a href="http://daux.io">daux.io</a></small>
                    </div>
                    <div class="col-sm-5">
                        ...
                        <article>
                            <?php if ($params['date_modified']) { ?>
                                <div class="page-header sub-header clearfix">
                                    <h1 style="font-size: 1.6em!important;"><?php
